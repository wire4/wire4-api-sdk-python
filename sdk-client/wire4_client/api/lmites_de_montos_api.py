...
class LmitesDeMontosApi(object):
    ...
    def obtain_configurations_limits(self, authorization, suscription, **kwargs):  # noqa: E501
        ...
        :param str suscription: Identificador de la suscripción a esta API (required)
    ...
    def update_configurations(self, body, authorization, suscription, **kwargs):  # noqa: E501
        """Actualiza las configuraciones por subscripción  # noqa: E501

        Actualiza las configuraciones de un contrato asociado a una subscripción  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
